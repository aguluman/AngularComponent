...
export abstract class SignalService {
  ...
  protected constructor(protected fetchService: FetchService) {
  ...
  //for conceptual GETs that have to be queried via a HTTP Post
  // (because we need a BODY to send all query data to the backend)
